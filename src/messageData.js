const messages =[
    {
        ...
        name: 'Hotdog',
        message: "I would like some peperoni.",
        recentTime: '21:30',
        index: 2,
    },
    {
    ...
    },
    {
        ...
        name: 'Burger',
        message: "Beef burger with extra cheese, please.",
        oldTime: 'Yesterday',
    },
    {
        id: 4,
        ...
        name: 'Spring rolls',
        message: "Lets have chicken springrolls with chilli sauce.",
        oldTime: 'Yesterday'
    },
    {
        id: 5,
        ...
        name: 'Tomato soup',
        message: "i would'nt mind having the soup of the day.",
        oldTime: '01/08/22',
    },
    {
        id: 6,
        ...
        message: "i'll like to have the spaghetti bolognaise.",
        oldTime: '01/08/22',
    },
    {
        id: 7,
        ...
        name: 'Lamb chops',
        message: "Bring on the lamb chops.",
        oldTime: '11/08/22',
    },
]
